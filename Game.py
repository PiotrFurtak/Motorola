...
class Game:
    def __init__(self, window):
        ...
        # Inicjalizacja toru i innych obiektów gry
        self.track = get_level("level-1.txt", window, pygame.image.load("imgs/turn.png"),
                               pygame.image.load("imgs/forward.png"))
    ...
    def draw(self):
        ...
        # Jeśli gra jest aktywna, włącz radio
        if self.radio:
            self.radio.draw()
