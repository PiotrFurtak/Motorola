...
class Game(ai):
    def __init__(self, window):
        ...
        self.lap_count = 0  # Licznik okrążeń
    ...
    def draw(self):
        ...
        laps_text = self.font.render(f"Okrążenia: {self.lap_count}", True, (0, 0, 0))
    ...
    def game_loop(self):
        ...
        while self.running:
            ...
            self.lap_count = self.player.loops  # Aktualizacja licznika okrążeń
